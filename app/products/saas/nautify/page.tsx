            ...
            <section className="py-16 bg-gradient-to-br from-purple-50 to-pink-50">
                <div className="container-custom">
                    ...
                    <div className="max-w-6xl mx-auto relative group">
                        ...
                        >
                            {[
                                { src: '/nautify/01.JPG', title: 'Login Page', desc: 'Secure access with real-time system insights' },
                                { src: '/nautify/02.JPG', title: 'Dashboard Overview', desc: 'Centralized view of all documents and alerts' },
                                { src: '/nautify/03.JPG', title: 'Dashboard Overview', desc: 'Recent Documents & Compliance by Category' },
                                { src: '/nautify/04.JPG', title: 'Dashboard Overview', desc: 'Never miss renewals or expiry deadlines' },
                                { src: '/nautify/05.JPG', title: 'Document Management', desc: 'Organize, store, and manage documents effortlessly' },
                                { src: '/nautify/06.JPG', title: 'Document Management', desc: 'Upload and manage files with ease' },
                                { src: '/nautify/07.JPG', title: 'Calendar View', desc: 'Monitor renewals and expiry dates with ease' },
                                { src: '/nautify/08.JPG', title: 'Overdue Docs & Alerts', desc: 'Quickly identify and resolve overdue items' },
                                { src: '/nautify/09.JPG', title: 'Alert Schedules', desc: 'Automated reminders tailored to your workflow' },
                                { src: '/nautify/10.JPG', title: 'Notifications', desc: 'Multi-channel notifications for alerts and activities' },
                                { src: '/nautify/11.JPG', title: 'Custom Notifications', desc: 'Tailored alerts for specific document types' },
                                { src: '/nautify/12.JPG', title: 'Compliance Dashboard', desc: 'Complete document details and metadata' },
                                { src: '/nautify/13.JPG', title: 'Compliance by Category', desc: 'Simplify compliance across departments' },
                                { src: '/nautify/14.JPG', title: 'Audit Trail', desc: 'Full visibility of every action and change' },
                                { src: '/nautify/15.JPG', title: 'Reports & Analytics', desc: 'Access insights from anywhere, anytime' },
                                { src: '/nautify/16.JPG', title: 'Export Options', desc: 'Collaborate using shared data exports' },
                                { src: '/nautify/17.JPG', title: 'Custom Reports', desc: 'Reports designed around your business needs' },
                                { src: '/nautify/18.JPG', title: 'Settings', desc: 'Integrate Nautify with your existing tools' },
                                { src: '/nautify/19.JPG', title: 'Account Settings & Organization', desc: 'Enterprise-grade security and control' },
                                { src: '/nautify/20.JPG', title: 'Custom Preferences', desc: 'Perform bulk actions in just a few clicks' },
                                { src: '/nautify/21.JPG', title: 'Security & Privacy', desc: 'Monitor access and track all changes' },
                                { src: '/nautify/22.JPG', title: 'Data Backup & Deactivation', desc: 'Export and manage data in multiple formats' }
                            ].map((image, index) => (
                                <div
                                    key={index}
