...
const pricingTiers = [
    {
        tier: 'Small Office',
        scope: 'Up to 50 users',
        price: 'Starting at $15,000',
        includes: ['2x access switches (24-port PoE)', '3-5 wireless APs', 'Basic firewall', 'Configuration & setup', '1-year warranty'],
    },
    {
        tier: 'Medium Enterprise',
        scope: '50-500 users',
        price: 'Starting at $75,000',
        includes: ['Core + access switches', '10-30 wireless APs', 'Enterprise firewall', 'SD-WAN setup', 'Wireless controller', 'Full configuration', '3-year warranty & support'],
        popular: true,
    },
    {
        tier: 'Large Campus',
        ...
        includes: ['Redundant core switches', 'Full access layer', '50+ wireless APs', 'Advanced SD-WAN', 'Network management platform', 'Comprehensive support', '5-year warranty'],
    },
]
    ...
    return (
        <>
            ...
            <section className="section-padding bg-gray-50">
                <div className="container-custom">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-display font-bold text-gray-900 mb-4">Pricing Packages</h2>
                    </div>
