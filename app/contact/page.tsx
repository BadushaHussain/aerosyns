                            ...
                            <div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-start">
                                        ...
                                        <div className="ml-4">
                                            <h4 className="text-lg font-semibold text-gray-900">Headquarters (UAE)</h4>
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <p className="text-gray-600">UAE: +971 556725264</p>
                                            <p className="text-gray-600">India: +91 9895529203</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start">
                                        <div className="flex-shrink-0">
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <p className="text-gray-600">General: info@aerosyns.com</p>
                                            <p className="text-gray-600">Sales: sales@aerosyns.com</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
