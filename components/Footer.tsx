            ...
            <div className="container-custom section-padding">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
                        ...
                        <div className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="flex items-start text-gray-400">
                                    <MapPinIcon className="h-5 w-5 mr-3 text-primary-500 mt-0.5 flex-shrink-0" />
                                    <div className="text-sm">
                                        <div className="font-semibold text-white mb-1">India Office (Aerosyns Private Limited)</div>
                    ...
                    <div>
                        ...
                        <h3 className="text-sm font-semibold text-white tracking-wider uppercase mb-4 mt-8">
                            Company
                        </h3>
                        <ul className="space-y-3">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-gray-400 mb-8">
                            ...
                            <li>SOC 2 Type II</li>
                            <li>UAE Data Residency</li>
                            <li>Tier III Datacenter</li>
                        </ul>
                        <h3 className="text-sm font-semibold text-white tracking-wider uppercase mb-4">
                            Legal
                        </h3>
